    ...
    <div className="flex lg:w-4/5 lg:mx-auto mt-2 lg:mt-12">
      <div className="w-4/5 mx-auto lg:mx-0 lg:w-6/12 flex flex-col justify-start mt-4 lg:mt-0 lg:justify-center items-start h-[300px] lg:h-[450px]">
        ...
        <p class="mt-5 font-bold">
          <p class="text-[#70ff00] text-3xl lg:text-4xl tracking-widest">
            {" "}
            <i class="fa fa-angle-left text-[#70ff00] text-3xl lg:text-4xl"></i>
            {" Sai  "}{" "}
          </p>
          <p class="mt-4 text-[#70ff00] text-3xl lg:text-4xl tracking-widest">
            {"Chandu /"}
            <i class="fa fa-angle-right text-[#70ff00] text-3xl lg:text-4xl"></i>{" "}
          </p>
        </p>
