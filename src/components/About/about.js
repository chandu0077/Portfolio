const About = ({ globalColor }) => {
  return (
    <div
      class="w-full bg-[#212121] px-2 lg:px-6 py-12"
      id="about"
      style={{
      ...
      <div class="w-full lg:w-4/5 mx-auto h-[auto]">
        <div class="flex justify-between flex-col lg:flex-row ">
          <div class="w-full lg:w-6/12 h-[200px]">
            <h2
              class="text-[#70ff00] text-2xl lg:text-3xl font-medium"
              style={{
          ...
          <div class="w-full lg:w-4/12 h-[200px]">
            <div class="w-full h-[80px] bg-[#4f4f4f] p-5 rounded-md shadow-xl">
              <div class="flex justify-between">
                ...
                <i
                  class="fa fa-code text-[#70ff00] text-xl"
                  style={{
                    color: `oklch(0.75 0.14 ${globalColor})`,
                  }}
                ></i>
            ...
            <div class="w-full h-[80px] bg-[#4f4f4f] p-5 mt-3 rounded-md shadow-xl">
              <div class="flex justify-between ">
                ...
                <i
                  class="fa fa-globe text-[#70ff00] text-xl"
                  style={{
                    color: `oklch(0.75 0.14 ${globalColor})`,
                  }}
                ></i>
